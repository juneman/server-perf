...
static void netmap_init_pipeline(netmap_pipeline_t *line, int capcity)
{
    ...
    squeue_init(&(line->send_idle_queue), capcity, capcity, SQUEUE_MUL_READ | SQUEUE_MUL_WRITE);
...
//    squeue_use(&(line->recv_idle_queue));
